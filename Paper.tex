...
%
\title{A knowledge-based approach to address the problem of HRC workplace implementation}
%
\titlerunning{A knowledge-based approach}  % abbreviated title (for running head)
%                                     also used for the TOC unless
%                                     \toctitle is used
%
\author{Castrese Di Marino\inst{1} \and Andrea Rega\inst{2}}
%
\authorrunning{Castrese Di Marino et al.} % abbreviated author list (for running head)
%
%%%% list of authors for the TOC (use if author list has to be modified)
\tocauthor{Castrese Di Marin, Andrea Rega}
%
\institute{Univerisity of Bergamo, Address, ITA,\\
\email{castrese.dimarino@unibg.it},
\and
...
\begin{abstract}
The abstract should summarize the  \dots
...
%
With this chapter \cite{mella_holonic_2009}, the preliminaries are over, and we begin the search
for periodic solutions to Hamiltonian systems \cite{van_brussel_reference_1998}. All this will be done in
...
obtained by Rabinowitz in \cite{karimi_knowledge-based_2017}, who showed the existence of \cite{Vitolo2019a}
